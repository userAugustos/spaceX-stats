export function Load() {
 return(
  ...
  <span
    className="inline-block min-h-[4rem] w-full flex-auto cursor-wait bg-current align-middle text-base text-neutral-700 opacity-50 dark:text-neutral-50"></span>
    </p>
    <p
